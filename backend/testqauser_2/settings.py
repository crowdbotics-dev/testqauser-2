"""
Django settings for testqauser_2 project.
...
ROOT_URLCONF = 'testqauser_2.urls'
...
WSGI_APPLICATION = 'testqauser_2.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "testqauser_2 API",
    "DESCRIPTION": "API documentation for testqauser_2 App",
    "VERSION": "v1",
}
